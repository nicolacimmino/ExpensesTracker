...
// We use jade as a view engine. This is not central  to the API as we only serve JSON data but is used
// for couple of pages giving human readable information about the API. This is mainly experimental, content
// is so static that this is really not necessary.
app.set('views', path.join(__dirname, 'views'));
app.set('view engine', 'jade');

// From here we start injecting dependencies into the  express application. Each module needed by expess
// is to be injected here with the "app.use()".  NOTE: order matters, injected middleware is executed
...
// Serve static ontent such as pictures from the "public"  folder.
